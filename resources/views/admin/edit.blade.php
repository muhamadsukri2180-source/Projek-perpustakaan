            ...
            <div class="flex items-center justify-between h-16">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <span class="font-extrabold text-xl tracking-wide text-white drop-shadow-sm">
                        Perpustakaan <span class="text-xs font-semibold uppercase bg-white/20 px-2 py-0.5 rounded-md ml-1">Admin</span>
                    </span>
                </div>
                ...
                <div class="hidden md:flex items-center gap-1 font-medium text-sm">
                    ...
                    <a href="{{ Route::has('admin.siswa.index') ? route('admin.siswa.index') : '#' }}" 
                ...
                <div class="flex items-center gap-3">
                    <div class="hidden sm:flex flex-col text-right">
                        <span class="text-xs font-bold leading-tight">{{ Auth::user()->name ?? 'Administrator' }}</span>
                        <span class="text-[10px] text-blue-200">Admin Utama</span>
                    </div>
